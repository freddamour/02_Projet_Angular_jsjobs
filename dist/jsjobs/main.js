...
module.exports = "<p>\n  job-list works!\n</p>\n\n<div *ngFor=\"let job of jobs\">\n  {{job.title}}\n</div>\n<ngb-alert type=\"primary\" [dismissible]=\"true\">ok boostrape </ngb-alert>"
...
/* harmony import */ var _services_job_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../services/job.service */ "./src/app/services/job.service.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var JobListComponent = /** @class */ (function () {
    ...
    JobListComponent.prototype.ngOnInit = function () {
        ...
        var _this = this;
        this.jobService.getJobs().subscribe(function (data) { return _this.jobs = data; }, function (error) {
            console.error(error);
            _this.error = error;
        });
    };
    JobListComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./job-list.component.html */ "./src/app/job-list/job-list.component.html"),
            styles: [__webpack_require__(/*! ./job-list.component.css */ "./src/app/job-list/job-list.component.css")]
        }),
        __metadata("design:paramtypes", [_services_job_service__WEBPACK_IMPORTED_MODULE_0__["JobService"]])
    ], JobListComponent);
...
module.exports = __webpack_require__(/*! D:\0 Projet\00 projet GIT\03 model\05 CodeConcept\02_Projet_Angular\jsjobs-V5\src\main.ts */"./src/main.ts");
